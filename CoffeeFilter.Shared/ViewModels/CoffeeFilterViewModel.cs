					...
					try {
						...
						if (queryObject != null && queryObject.Places != null) {
							if (string.IsNullOrWhiteSpace (query))
								...
								Places = queryObject.Places.OrderBy (p => p.GetDistance (Position.Latitude,
